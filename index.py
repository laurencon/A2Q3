...
# FILENAME: index.py
# SPECIFICATION: This program is meant to be for the interaction functions for users to utilizw
#                that's defined in the db_connection_solution.py file. It handles user input
